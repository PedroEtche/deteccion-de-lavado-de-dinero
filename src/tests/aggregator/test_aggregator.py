...
from common.communication.internal import serialize, build_batch_message, build_eof_message

@pytest.fixture
def mock_middleware(monkeypatch):
    with patch("src.aggregator.main.middleware.MessageMiddlewareQueueRabbitMQ") as mock_rabbit:
        yield mock_rabbit
...
def test_aggregator_integration_payment_format_average(mock_middleware, service_config_payment):
    ...
    batch_data = [
        {"from_bank": "BankA", "from_account": "123", "payment_format": "Cash", "total_amount": 50.0, "tx_quantity": 1},
        {"from_bank": "BankA", "from_account": "123", "payment_format": "Cash", "total_amount": 150.0, "tx_quantity": 1},
        {"from_bank": "BankB", "from_account": "456", "payment_format": "Credit", "total_amount": 300.0, "tx_quantity": 2},
    ]
