...
def main():
    ...
    parser.add_argument("--target", required=True, help="Nombre (o substring) del container a atacar")
    parser.add_argument("--interval", type=int, default=5, help="Segundos entre intentos de kill")
    ...
    try:
        while True:
            ...
            if victim:
                ...
                print(f"[{now()}] [chaos] Target '{args.target}' no encontrado. Esperando...")
